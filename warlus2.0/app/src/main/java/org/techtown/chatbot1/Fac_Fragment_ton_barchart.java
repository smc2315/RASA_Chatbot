...
public class Fac_Fragment_ton_barchart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_fac_ton_barchart, container, false);
        Bundle ton_bundle = getArguments();
        Parceldata ton_data = ton_bundle.getParcelable("ton_data");
        dataList = ton_data.datalist;


        barChart = (BarChart)rootView.findViewById(R.id.fragment_fac_ton_barchart);
        graphInitSetting();
    ...
    //    labelList.add("1만톤 이상");
    //labelList.add("1만톤 미만 1천톤 이상");
    //    labelList.add("1천톤 미만");
