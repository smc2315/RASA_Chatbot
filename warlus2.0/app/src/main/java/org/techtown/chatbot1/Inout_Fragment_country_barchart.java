...
public class Inout_Fragment_country_barchart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup view =(ViewGroup) inflater.inflate(R.layout.fragment_inout_country_barchart, container, false);
        Bundle country_bundle = getArguments();
        Parceldata country_data = country_bundle.getParcelable("country_data");
        barChart = (BarChart) view.findViewById(R.id.inout_country_bc);
