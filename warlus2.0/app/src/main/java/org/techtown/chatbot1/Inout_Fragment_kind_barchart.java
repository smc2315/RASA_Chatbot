...
public class Inout_Fragment_kind_barchart extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup view =(ViewGroup) inflater.inflate(R.layout.fragment_inout_kind_barchart, container, false);
        Bundle kind_bundle = getArguments();
        Parceldata kind_data = kind_bundle.getParcelable("kind_data");
        barChart = (BarChart) view.findViewById(R.id.inout_kind_bc);
